<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            {{ Form::label('direcion') }}
            {{ Form::text('direcion', $contacto->direcion, ['class' => 'form-control' . ($errors->has('direcion') ? ' is-invalid' : ''), 'placeholder' => 'Direcion']) }}
            {!! $errors->first('direcion', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('telefono') }}
